...
/* package proj-0.1.0.0 */
#define VERSION_proj "0.1.0.0"
#define MIN_VERSION_proj(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "proj-0.1.0.0-GViSLdnWNEqHe1z7eCQaTl"

#define CURRENT_PACKAGE_KEY "proj-0.1.0.0-GViSLdnWNEqHe1z7eCQaTl"
